        ...
        when(v?.id){
            ...
            R.id.btn_move_activity_object -> {
                val person = Person (
                    "Nicholas Yang",
                    20,
                    "nicholsyoung25@gmail.com",
                    "Medan",
                )

                val moveWithObjectIntent = Intent (this@MainActivity, MoveActivityObject::class.java)
                moveWithObjectIntent.putExtra(MoveActivityObject.EXTRA_PERSON, person)
                startActivity(moveWithObjectIntent)
            }R.id.btn_dial_number -> {
                val phoneNumber = "081267643835"
